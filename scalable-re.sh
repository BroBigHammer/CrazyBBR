...
#	Description: BBR Smart Installation Package
#	Version: 0.1
#	Author: kanecolin
#=================================================
...
startscalable-re(){
	...
	wget -O /etc/sysctl.conf -N --no-check-certificate https://raw.githubusercontent.com/kanecolin/CrazyBBR/master/scalable-re.conf
	sysctl -p
